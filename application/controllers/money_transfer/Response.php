	...
	function view($id){
		...
		//print_r($_POST);
			...
			if($_POST['f_code']=="Ok"){
				...
				$sts_arr['txt']= "Transaction Processed Successfully. Thank You to Donate us.";
				
			}else{
				$sts_arr['txt']=  "Transaction Not Processed Successfully. Please Try Again OR Contact SSPIS.";
				//exit;
			}
			
			$this->load->view('comman/top_header');
			$this->load->view('comman/header_menu');
			$this->load->view('response_view_new',$sts_arr);
