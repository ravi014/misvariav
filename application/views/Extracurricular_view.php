                ...
                <div class="gdlr-core-tab-item gdlr-core-js gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-tab-style1-horizontal gdlr-core-item-pdlr">
                    ...
                    <div class="gdlr-core-tab-item-wrap">
                        <div class="gdlr-core-tab-item-title-wrap clearfix gdlr-core-title-font">
                            <a href="<?=base_url()?>index.php/extracurricular"><div class="gdlr-core-tab-item-title  gdlr-core-active" data-tab-id="1">Extracurricular</div></a>
                            <a href="<?=base_url()?>index.php/sports"><div class="gdlr-core-tab-item-title " data-tab-id="1">Sports</div></a>
                            <a href="<?=base_url()?>index.php/achievements"><div class="gdlr-core-tab-item-title " data-tab-id="1">Achievements</div></a>
                        </div>
                        <div class="gdlr-core-tab-item-content-wrap clearfix">
                            <div class="gdlr-core-tab-item-content  gdlr-core-active align" data-tab-id="1" >
                                 <p><?php 
                                        ...
                                        {
                                        if($result[$i]['page_title'] == 'extracurricular')
                                        {
                                        ?>
                                        <?=$result[$i]['contain']?>
                                        <?php }
