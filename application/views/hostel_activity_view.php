        ...
        <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
            <div class="gdlr-core-pbf-element">
                <div class="gdlr-core-tab-item gdlr-core-js gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-tab-style1-horizontal gdlr-core-item-pdlr">
                    ...
                    <div class="gdlr-core-tab-item-content-image-wrap" style="height: 700px !important;">
                        <div class="gdlr-core-tab-item-image  gdlr-core-active" data-tab-id="1">
                            <img height="10px;" src="<?=base_url();?>admin/upload/img/<?=$header_img[0]['img_path']?>" alt="">
                        </div>
                    ...
                    <div class="gdlr-core-tab-item-wrap">
                        <div class="gdlr-core-tab-item-title-wrap clearfix gdlr-core-title-font">
                            ...
                            <a href="<?=base_url()?>index.php/daily_routine"><div class="gdlr-core-tab-item-title " data-tab-id="1">Daily Routine</div></a>
                            <a href="<?=base_url()?>index.php/hostel_activity"><div class="gdlr-core-tab-item-title gdlr-core-active" data-tab-id="1">Hostel Activity
                            </div></a>
                        ...
                        <div class="gdlr-core-tab-item-content-wrap clearfix">
                            <div class="gdlr-core-tab-item-content  gdlr-core-active align" data-tab-id="1" >
                               ...
                               {
                                if($result[$i]['page_title'] == 'hostel_activity')
                                {
                                    ?>
                                    <?=$result[$i]['contain']?>
                                <?php }
