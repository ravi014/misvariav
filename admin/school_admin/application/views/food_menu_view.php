...
<div class="page-heading">
        ...
        FOOD MENU MASTER
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">Food Menu Master </li>
            <?php  	if($segment['mode']=='Edit'){ ?>
                 <li class="active"><?=$segment['mode']?> Food List </li>
                 <?php } ?>
            </ul>
  ...
  <div class="row">
    ...
    <div class="col-sm-5">
      ...
      <section class="panel">
        ...
        <header class="panel-heading">FOOD NAME
           <?=$segment['mode']?>
        </header>
           ...
           <input type="hidden" name="<?php echo  $this->security->get_csrf_token_name(); ?>"  value="<?=$this->security->get_csrf_hash();?>" />
              ...
              <input type="hidden" name="eid" id="eid" 	 value="<?=$segment['eid']?>" />
               <div class="form-group ">
                 <label for="cname" class="control-label col-lg-2"><strong>Type</strong></label>
                 <div class="col-lg-8">
                  <select  name="type" id="type"  class="form-control"  >
                
<option value="Lunch" <?php if($result[0]['type']=="Lunch"){ ?> selected <?php }?> <?php echo set_select('type', 'Lunch'); ?> />LUNCH </option>
<option value="Dinner" <?php if($result[0]['type']=="Dinner"){ ?> selected <?php }?> <?php echo set_select('type', 'Dinner'); ?> />DINNER </option>
             </select>
    ...
    <div class="col-sm-7">
      ...
      <section class="panel">
        <header class="panel-heading">Menu List 
