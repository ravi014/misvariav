  ...
  <div class="row">
    ...
    <div class="col-sm-5">
      ...
      <section class="panel">
        ...
        <header class="panel-heading">EXAM LIST 
           <?=$segment['mode']?>
        </header>
        <div class="panel-body">
          ...
          <input class="form-control"  name="old_name" id="old_name" type="hidden" value="<?=$result[0]['exam_title']?>" />
           ...
           <input type="hidden" name="<?php echo  $this->security->get_csrf_token_name(); ?>"  value="<?=$this->security->get_csrf_hash();?>" />
              ...
              <input type="hidden" name="eid" id="eid" 	 value="<?=$segment['eid']?>" />
               <div class="form-group ">
                 ...
                 <div class="col-lg-8">
                  <input class="form-control"  name="exam_title" required id="name" type="text"  value="<?php echo set_value('exam_title', ''.$result[0]['exam_title'].''); ?>"/>
                 <?php echo form_error('exam_title', '<p class="error">', '</p>'); ?>
                </div>
             </div>
