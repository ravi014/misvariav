...
<script type="text/javascript" charset="utf-8">//
	$(document).ready(function() {
		...
		var oTable = $('#data-table').dataTable( {
					...
					"sAjaxSource": '<?php echo base_url();?>index.php/achievement/listing',
					"iDisplayLength": 25,
  					"bDestroy": true
		});
		...
		$(document).on('click', '.delrcd', function (e) {
			...
			$.ajax({url:url,success:function(result){
					...
					var oTable = $('#data-table').dataTable( { 
						"bProcessing": true,sPaginationType: "full_numbers","sAjaxSource": '<?php echo base_url();?>index.php/achievement/listing',"iDisplayLength": 25,"bDestroy": true
			  		});
...
<div class="wrapper">
  <div class="row">
    ...
    <div class="col-sm-12">
      ...
      <section class="panel">
        <header class="panel-heading">Achievement List 
