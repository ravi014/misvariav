...
<div class="page-heading">
            ...
            <?php  	if($this->uri->segment(3)=='Edit'){ ?>
                 <li class="active"><?=$segment['mode']?> Fee Head</li>
                 <?php } ?>
            </ul>
...
<div class="wrapper">
  <div class="row">
           ...
           <input type="hidden" name="<?php echo  $this->security->get_csrf_token_name(); ?>"  value="<?=$this->security->get_csrf_hash();?>" />
              ...
              <input type="hidden" name="eid" id="eid" 	 value="<?=$segment['eid']?>" />
               <div class="form-group ">
                 ...
                 <div class="col-lg-8">
                  <input class="form-control"  name="name" required id="name" type="text"  value="<?php echo set_value('name', ''.$result[0]['head_name'].''); ?>"/>
    ...
    <div class="col-sm-7">
      ...
      <section class="panel">
        <header class="panel-heading">Fee Head List 
