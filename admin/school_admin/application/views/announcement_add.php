  ...
  <div class="row">
	...
	<?php }?>
          ...
          <div class="form">
                ...
                <input type="hidden" name="page_type" id="page_type" value="announcement" />
                
               <div class="form-group ">
                 <label for="cname" class="control-label col-lg-2"><strong>Title</strong></label>
               
                 <div class="col-lg-4">
                  <input class="form-control" required  name="page_title" id="page_title" type="text" value="<?=$result[0]['page_title']?>"  data-validate="required" data-message-required="Enter Contain" placeholder="Title"  />
                  </div>
                
              </div>
               
               <div class="form-group ">
                 <label for="cname" class="control-label col-lg-2"><strong>Url</strong></label>
               
                 <div class="col-lg-4">
                  <input class="form-control" required  name="contain" id="contain" type="text" value="<?=$result[0]['contain']?>" placeholder="Url" />
                  </div>
