<div class="page-heading">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"> <a id="ab" href="<?php echo base_url(); ?>index.php/photo_gallery">Photo Gallery</a></li>
...
<div class="wrapper">
  ...
  <?php } ?>
    <div class="col-sm-12">
      ...
      <section class="panel">
        <header class="panel-heading">Photo Gallery List 
