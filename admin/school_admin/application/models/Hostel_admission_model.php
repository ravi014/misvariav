<?php
Class Hostel_admission_model extends CI_Model
{
 	function getAll()
 	{	
		...
		//$this -> db -> select('division_master.name as division_name');
   		...
   		$this -> db -> from('hostel_student');
		
		$this -> db -> join('student_yearly_acccount','hostel_student.student_yearly_code = student_yearly_acccount.student_yearly_code','left');
		
		$this -> db -> join('student_master','student_master.student_code = hostel_student.student_code','left');
	...
	function get_student_by_standard($eid){
