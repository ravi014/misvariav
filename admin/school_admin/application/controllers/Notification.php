...
class Notification extends CI_Controller {
	...
	function get_data_list($receiver_code=null,$standard_code=null)
	{
	 ...
	 function get_student_list($standard_code=null){
	...
	function string_lower($string=null){
	...
	protected function send_notification($registatoin_ids=null, $message=null) {
