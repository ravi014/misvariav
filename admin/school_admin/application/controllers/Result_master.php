...
class Result_master extends CI_Controller {
	...
	function addnew($standard_code=null,$division_code=null,$subject_code=null,$exam=null,$year=null){
		$data['year']	=	$this->ObjM->get_year();
  ...
  function get_result($standard_code=null,$division_code=null,$subject_code=null,$exam=null,$year=null){
	...
	for($i=0;$i<count($all_student);$i++){
	 ...
	 function get_result1($standard_code=null,$division_code=null,$subject_code=null,$exam=null,$year=null){
...
function get_standard($eid=null){
		$html1='<option value="">--Select--</option>';
