...
<div class="page-heading">
  ...
  <ul class="breadcrumb">
    ...
    <li class="active"> <a id="ab" href="<?php echo base_url(); ?>index.php/city">City</a></li>
...
<div class="wrapper">
  <div class="row">
          ...
          <div class=" form">
            <form class="cmxform form-horizontal" id="frm" method="post" action="<?php echo base_url();?>index.php/<?=$this->uri->segment(1)?>/insertrecord">
              ...
              <div class="form-group ">
                ...
                <div class="col-lg-8">
                  <select class="form-control"  id="stateid" name="stateid" required data-rule-required="true">
                    <option value="">--Select--</option>
                    <?php
                        	for($i=0;$i<count($state);$i++){
								$sel="";
								if($state[$i]['stateid']==$result[0]['stateid']){
									$sel='selected="selected"';	
								}
								echo  "<option ".$sel." ".set_select('stateid', ''.$state[$i]['stateid'].'')." value='".$state[$i]['stateid']."'>".$state[$i]['name']."</option>";	
							}
						?>
                  </select>
                  <?php echo form_error('stateid', '<p class="error">', '</p>'); ?> </div>
              </div>
              <div class="form-group ">
    ...
    <div class="col-sm-7">
      <section class="panel">
        <header class="panel-heading">City List </header>
        <div class="panel-body">
          <div class="adv-table">
