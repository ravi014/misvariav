...
<div class="page-heading">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"> Current Year </li>
            <?php  	if($segment['mode']=='Edit'){ ?>
                 <li class="active"><?=$segment['mode']?> Current Year </li>
                 <?php } ?>
            </ul>
  ...
  <div class="row">
    ...
    <div class="col-sm-5">
      ...
      <section class="panel">
        ...
        <header class="panel-heading">CURRENT YEAR 
           <?=$segment['mode']?>
        </header>
        <div class="panel-body">
          ...
          <input class="form-control"  name="old_name" id="old_name" type="hidden" value="<?=$result[0]['yeanm']?>" />
           ...
           <input type="hidden" name="<?php echo  $this->security->get_csrf_token_name(); ?>"  value="<?=$this->security->get_csrf_hash();?>" />
              ...
              <input type="hidden" name="eid" id="eid" 	 value="<?=$segment['eid']?>" />
               <div class="form-group ">
                 ...
                 <div class="col-lg-8">
                  <input class="form-control"  name="yeanm" required id="name" type="text"  value="<?php echo set_value('yeanm', ''.$result[0]['yeanm'].''); ?>"/>
                 <?php echo form_error('yeanm', '<p class="error">', '</p>'); ?>
                </div>
             </div>
    ...
    <div class="col-sm-7">
      ...
      <section class="panel">
        <header class="panel-heading">Year List 
