                ...
                <div class="row">
					<div class="col-sm-5">
						...
						<div class="row">
							...
							<div class="col-lg-10 col-xs-9">
								<h4 class="no-margin">Phone &amp; Fax</h4>
								Phone: <a href="tel:+912692283845">+91 2692 283845</a><br>
								phone: <a href="tel:+919446489192">+91 94464 89192</a><br>
                             	Fax: <a href="tel:02692283645">02692-283645</a>
						...
						<div class="row">
							...
							<div class="col-lg-10 col-xs-9">
								...
								Email: <a href="mailto:principal@sspis.org">principal@sspis.org</a><br>
								Email: <a href="mailto:admin@sspis.org">admin@sspis.org</a>
							</div>
						</div>
					</div>
                    ...
                    <div class="col-sm-7">
						...
						<div class="row">
                            ...
                            <div class="col-sm-12 form-group" style="text-align:center!important;">
                                ...
                                <button id="regbtn" type="submit" class="btn btn-primary" style="margin-top:10px;">Register</button>
